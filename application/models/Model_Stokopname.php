<?php 
class Model_Stokopname extends CI_Model{
...
public function listdatastokopname($limit,$offset){
		$q = $this->db->query("select tb_stokopname.Normalisasi,tb_stokopname.Id_Stokopname,tb_stokopname.Tanggal_Stokopname, tb_user.Nama, tb_user.Username
...
public function searchingdatastokopname(){
		...
		$b = $this->db->query("select tb_stokopname.Normalisasi, tb_stokopname.Id_Stokopname,tb_stokopname.Tanggal_Stokopname, tb_user.Nama,tb_user.Username
		from tb_stokopname join tb_user
		on tb_stokopname.Kode_User = tb_user.Kode_User
