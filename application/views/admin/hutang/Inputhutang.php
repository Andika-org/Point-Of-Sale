...
<legend>
	...
	<form class="form-signin" method="POST" action="<?php echo base_url();?>Hutang/masukhutang/<?php echo $nota ?>" enctype="multipart/form-data">

	<table id="table" style="border:none;">
		<tr>
			<td>
				<h3 style="width:300px">Hutang Pembelian</h3>
			</td>
		...
		<tr>
			...
			<td>
			<input type="text" id="total" class="form-control" style="margin-top:20px; width:300px; background-color:#FFFFAA;" value="<?php echo 'Rp. '.number_format($datapenjualan["Total_Pembelian"],0,",",".");?>" readonly="readonly"> 
		...
		<table class="table" style="margin-bottom:65px;background-color:white;">
			<tr>
				...
				<td style="border-top:1px solid white;">
					...
					<input name="Id_Customer" type="hidden" id="Id_Customer" required class="form form-control">
					<input name="Nama_Barang" onclick="namacustomer();" id="name" type="text" required class="autocompletecustomer form form-control">
				</td>
			</tr>
			...
			<tr>
				...
				<td style="border-top:1px solid white;">
						<div class="input-group date form_date col-md-12" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd" >
							<input required style="background:white;" class="form-control" type="text" name="Tanggal_Tempo_Hutang"  readonly="readonly">
			...
			<tr >
				...
				<td style="border-top:1px solid white;">
					<textarea readonly="readonly" id="Alamat" class="form form-control"></textarea>
				</td>
			</tr>
			<tr>
				<td style="border-top:1px solid white;">Telepon</td>
				<td style="border-top:1px solid white;">
					<input id="Telepon" readonly="readonly" type="text" required class="form form-control">
				</td>
			</tr>
			<tr>
				<td style="border-top:1px solid white;">Email</td>
				<td style="border-top:1px solid white;">
					<input id="Email" readonly="readonly" type="text" required class="form form-control">
				</td>
			</tr>
	...
	<div class="col-xs-6">
		...
		<table class="table" style="margin-bottom:0px;background-color:white;">
			...
			<tr>
				...
				<td style="border-top:1px solid white;">
				<input type="hidden" id="totalhutang"  class="form-control" value="<?php echo substr($datapenjualan["Sisa"],1);?>" readonly="readonly">
				<input type="hidden" name="Total_Hutang"  class="form-control" value="<?php echo $datapenjualan["Sisa"];?>" readonly="readonly">
				<input type="text" class="form-control" value="<?php echo 'Rp. '.substr(number_format($datapenjualan["Sisa"],0,",","."),1);?>" readonly="readonly">
				</td>
			</tr>
			<tr>
				...
				<td style="border-top:1px solid white;">
				<div class="input-group">
					<input type="text" required id="bunga" onkeyup="sumbunga();" name="Bunga" class="form form-control" style="width:60px;border-right:none;" value="0">
					...
					<input type="text" required id="nominalbunga" value="<?php echo substr($datapenjualan["Sisa"],1);?>" readonly="readonly" name="Nominal_Bunga" class="form form-control" style="background:white;border-left:none;width:100px;border-right:;">
				</div>
				<td style="border-top:1px solid white;">
			</tr>
			<tr>
				...
				<td style="border-top:1px solid white;">
					<input name="Status" type="text" readonly="readonly" value="Hutang" required class="form form-control">
				</td>
			</tr>
		</table>
