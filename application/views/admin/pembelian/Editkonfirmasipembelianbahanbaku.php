...
?>
<!-- akses supplier -->
<form class="form-signin" method="POST" action="<?php echo base_url();?>pembelian/editnota/" enctype="multipart/form-data">
...
<!-- sampe sini -->
	...
	<div class="panel-heading" style="border:1px solid #DDDDDD;margin-bottom:-4px;background:#DDDDDD;">
		...
		<button type="submit" title="Proses Update" class="glyphicon glyphicon-edit btn btn-link pull-right" style="margin-top:-10px;"> Update Payment</button>
				</div>
		<!--<div class="panel-body" style="border:1px solid #DDDDDD;height:468px;">-->
        <div class="panel-body" style="border:1px solid #DDDDDD;">                
