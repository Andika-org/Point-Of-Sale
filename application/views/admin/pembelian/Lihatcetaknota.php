...
<div class="col-xs-11 pull-right" style="padding-left:120px;"> 
	...
	<a class="btn btn-danger glyphicon glyphicon-chevron-left" href="<?php echo base_url().'Pembelian/index';?>"> Back</a>
	...
	<a  class="pull-right" href="<?php echo base_url('Pembelian/cetaknotaexcel/'.$faktur); ?>">
...
<div class="col-xs-12" style="padding-top:15px;padding-bottom:15px;">
	<table class="" style="border:1px solid black;">
		...
		<tr>
			...
			<td style="padding-left:6px;border-top:0px solid #000;">Kepala Gudang</td>
			<td style="padding-left:6px;border-top:0px solid #000;"><center>:</center></td>
	...
	<table>
		...
		<tr style="border:1px solid black;border-top:0px">
			<td style="width:200px;padding-left:6px;">Discount</td>
			<td class="pullleft" style="padding-left:6px;border-bottom:0px solid #000;border-right:0px solid #000;"colspan="5">
			: <?php echo $baris['Discount'].' %';?>
			</td>
		</tr>
		
		<tr style="border:1px solid black;border-top:0px">
			<td style="padding-left:6px;">PPN</td>
		...
		<tr style="border:1px solid black;border-top:0px">
			<td style="padding-left:6px;">Jenis Pembayaran</td>
			<td style="padding-left:6px;">
		...
		<tr style="border:1px solid black;border-top:0px">
			<td style="padding-left:6px;">Nominal Bayar</td>
			<td style="padding-left:6px;">
		...
		<tr style="border:1px solid black;border-top:0px">
			<td style="padding-left:6px;">Kembali</td>
			<td style="padding-left:6px;">
		...
		?>
		<tr style="border:1px solid black;border-top:0px">
			<td style="padding-left:6px;">Nama Bank</td>
			<td style="padding-left:6px;">
		...
		<tr style="border:1px solid black;border-top:0px">
			<td style="padding-left:6px;">Nomor Rekening</td>
			<td style="padding-left:6px;">
		...
		<tr style="border:1px solid black;border-top:0px">
			<td style="padding-left:6px;">Atas Nama</td>
			<td style="padding-left:6px;">
		...
		<tr style="border:1px solid black;border-top:0px">
			<td style="padding-left:6px;">Tanggal Jatuh Tempo</td>
			<td style="padding-left:6px;">
		...
		<tr style="border:1px solid black;border-top:0px">
			<td style="padding-left:6px;">Status Pembelian</td>
			<td style="padding-left:6px;">
	...
	<tr>
		<td colspan="6">&nbsp;<!--<b>NO. PO</b>--></td>

		
	</tr>
	<tr>
		<td colspan="6">&nbsp;<!--<b>NOTE</b>--></td>	
	</tr>
	
	<tr>
		<td colspan="3"><center><b>KEPALA GUDANG</b></center></td>
		<td colspan="3"><center><b>ACCOUNTANT<b></center></td>
