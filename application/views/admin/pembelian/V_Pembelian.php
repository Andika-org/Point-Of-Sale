...
function tambahdata(hakaksespurchase) {
	 if(hakaksespurchase == "Accountant"){
		...
		if (confirm("Are you sure continue to purchase ?")) {
				...
				window.location.href="<?php echo base_url('Pembelian/tambahpembelianbahanbaku')?>";
...
<table id="cetak" class="table" >
	...
	--> 
	<form action="<?php print site_url();?>/Pembelian/carinota" method="POST">
	...
	<br>
	<br>
	<form action="<?php print site_url();?>/pembelian/index2" method=POST>
	<div class="navbar-header pull-left">
	...
	<form action="<?php print site_url();?>/Pembelian/caripembelian" method=POST>
		...
		<td align="left" style="padding-top:4px;"><a onclick="return confirm('Silahkan Cek Nota Dengan Nomor Faktur <?php echo $baris->No_Faktur; ?> ')" href="<?php echo base_url('Pembelian/ceknota/'.$baris->No_Faktur); ?>"><span class="btn btn-link btn-sm glyphicon glyphicon-barcode" align="right"> <?php echo $baris->No_Faktur; ?></span></a>
		...
		<td align="center" style="padding-top:4px;">
			<?php $hakakses = $this->session->userdata['Hak_Akses'];
				if($hakakses == 'Supplier'){
			?>
			<a href="<?php echo base_url('Pembelian/editnota/'.$baris->No_Faktur); ?>"><span title="Set Payment" class="btn btn-success btn-sm glyphicon glyphicon-usd" align="right"></span></a>
			<a href="<?php echo base_url('Pembelian/cetaknota/'.$baris->No_Faktur); ?>"><span title="Print Preview" class="btn btn-primary btn-sm glyphicon glyphicon-print" align="right"></span></a>
				<?php }else{
					$status = $baris->Status_Pembelian;
					if($status == "Pending"){
					?>
		
			<span  title="Payment" onclick="payment('<?php echo $baris->No_Faktur ?>','<?php echo $this->session->userdata["Hak_Akses"]; ?>')" class="btn btn-success btn-sm glyphicon glyphicon-usd" align="right"></span>
			<a href="<?php echo base_url('Pembelian/viewhapuspembelian/'.$baris->No_Faktur); ?>"><span  title="Delete" class="btn btn-danger btn-sm glyphicon glyphicon-trash" align="right"></span></a>
			<a href="<?php echo base_url('Pembelian/cetaknota/'.$baris->No_Faktur); ?>"><span  title="Print Preview" class="btn btn-primary btn-sm glyphicon glyphicon-print" align="right"></span></a>
					<?php }else{?>
			<a href="<?php echo base_url('Pembelian/cetaknota/'.$baris->No_Faktur); ?>"><span  title="Print Preview" class="btn btn-primary btn-sm glyphicon glyphicon-print" align="right"></span></a>
					<?php } ?>			
		...
		<tr>
			<td colspan="7" class="datastatuspembelian" style="display:none;">
				<form method="post" action="<?php echo base_url('pembelian/statuspembelian'); ?>">
