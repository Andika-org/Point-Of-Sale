...
<script type="text/javascript"> 
	...
	$("#addlist").click( function() {
	   ...
	   $("#list").append('<div class="form-group" id="datalist">'
				+'<input required type="text" class="form form-control" name="Satuan_Bahan_Baku[]">'
...
/*
  ...
  <input type="hidden" id="dataakses" value="<?php echo $this->session->userdata["Hak_Akses"]; ?>">
  <script type="text/javascript">
...
<div class="col-xs-11 pull-right" style="padding-left:120px;"> 
	<h2 style="color:brown" align="center"><b>Data Satuan Barang</b></h2>
	<legend>
	</legend>
<table>
<tr>
...
<div class="navbar-header input-group">
	<form action="<?php print site_url();?>/SatuanBahanBaku/index" method=POST>
	...
	<td>
	<form action="<?php print site_url();?>/SatuanBahanBaku/carisatuanbahanbaku" method=POST>
		<div class="input-group pull-right">
		<input required name="caridatasatuanbahanbaku" style="margin:0px 0px 0px 0px; width:250px;" type="text" class='form-control' placeholder="Search Data...."/>
...
<div class="col-xs-6" >
		...
		<tr bgcolor="#66CCFF">
			...
			<th align="center"><b>Satuan Barang</b></th>
		...
		<tr>
		<td align="center" style="padding-top:15px;" ><?php echo $baris->Satuan_Bahan_Baku;?></td>
		<td align="center" >
		
		<span class="btn btn-danger btn-sm glyphicon glyphicon-trash" align="right" onclick="hapus('<?php echo $baris->Id_Satuan; ?>')"> Delete</span>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content" >
        ...
        <div class="modal-header">
          ...
          <h3 style="color:brown"><b>Tambah Data Satuan Barang</b></h3>
        </div>
<div class="modal-body " style="height:600px;">
	
         <form class="form-signin" method="POST" action="<?php echo base_url();?>SatuanBahanBaku/tambahsatuanbahanbaku/" enctype="multipart/form-data">
			...
			<div class="col-xs-6">
				<div class="form-group">
					<input type="button" value="Add List Satuan" id="addlist" class="form-control btn btn-primary">
				</div>
				<div class="form-group">
