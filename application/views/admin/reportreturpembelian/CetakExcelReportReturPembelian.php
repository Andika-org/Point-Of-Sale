 ...
 table td{
	 ...
	 vertical-align: top;
		...
		<table class="table table-hover">
			<tr>
				<td colspan="2"><b>REPORT RETUR BARANG</b></td>
				<td></td>
			...
			<tr>
				...
				<td></td>
				<td colspan="2">Tanggal selesai Retur</td>
				<td>:</td>
				<td style="text-align:left;"><?php echo date('d/m/Y',strtotime($header['Tanggal_SelesaiRetur'])); ?></td>
			</tr>	
			<tr>
