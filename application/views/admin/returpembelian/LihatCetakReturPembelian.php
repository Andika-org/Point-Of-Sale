...
<div class="col-xs-11 pull-right" style="padding-left:120px;"> 
	...
	<a class="btn btn-danger glyphicon glyphicon-chevron-left" href="<?php echo base_url().'ReturPembelian/index';?>"> Back</a>
	...
	<a  class="pull-right" href="<?php echo base_url('ReturPembelian/cetaknotaexcel/'.$header['No_Retur']); ?>">
 ...
 table td{
	 ...
	 vertical-align: top;
		...
		<table class="">
			<tr>
				<td style="padding-left:6px;" colspan="2"><b>RETUR BARANG</b></td>
			...
			<tr>
				...
				<td style="padding-left:6px;"></td>
				<td style="padding-left:6px;" colspan="2">Kepala Gudang</td>
				<td style="padding-left:6px;">:</td>
