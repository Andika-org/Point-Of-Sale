...
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="<?php echo base_url("");?>assets/menuloginnew/other/images/icons/favicon.ico"/>
<!--===============================================================================================-->
	...
	<div class="wrapper">
		<div class="container-login100" style="background-image: url('./assets/menuloginnew/other/images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" method="POST" action="<?php echo base_url("");?>index.php/Control/loginuser/">
					...
					<br>
						<center>
						<span class="label-input100">Copyright &copy; 2018 | Toko Karisma</span>
						</center>
					<!--<div class="flex-c-m">
